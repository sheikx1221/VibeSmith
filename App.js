...
import VybeFormButtonLess from './src/screens/MailScreens/VybeFormButtonLess';
...
function _VybeFormStack(props, Mode, handlerModeUpdate) {
  ...
  return (
    <VybeFormStack.Navigator>
      <VybeFormStack.Screen name="MainScreen" component={VybeFormButtonLess} options={CommonStackOptions(props, theme)} />
    </VybeFormStack.Navigator>
  )
}
...
const _BottomTabs = ({ Mode, handlerModeUpdate }) => {
  ...
  return (
    ...
    >
      <BottomNavigation.Screen name="TabWelcome" children={(props) => _HomeStack(props, Mode, handlerModeUpdate)} options={{
        tabBarLabel: "HOME",
        tabBarIcon: ({ color }) => (
      ...
      />
      <BottomNavigation.Screen name="TabPackages" children={(props) => _VybeFormStack(props, Mode, handlerModeUpdate)} options={{
        tabBarLabel: "HOME",
        tabBarIcon: ({ color }) => (
      ...
      />
      <BottomNavigation.Screen name="TabRecording" children={(props) => _DetectionStack(props, Mode, handlerModeUpdate)} options={{
        tabBarLabel: "HOME",
        tabBarIcon: ({ color }) => (
      ...
      />
      <BottomNavigation.Screen name="TabMail" children={(props) => _MailStack(props, Mode, handlerModeUpdate)} options={{
        tabBarLabel: "HOME",
        tabBarIcon: ({ color }) => (
          <View style={{ padding: 3 }}>
